...
export const geminiParserDraftSchema = z.object({
  ...
  destinationPaymentAccountId: z.string().nullable().optional(),
  destinationPaymentAccountName: z.string().nullable().optional(),
...
export const emptyGeminiParserDraft: GeminiParserDraft = {
  ...
  destinationPaymentAccountId: null,
  destinationPaymentAccountName: null,
  description: null,
  affectedObject: null,
  assumptions: [],
  missingFields: [],
